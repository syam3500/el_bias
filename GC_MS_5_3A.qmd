...
ggplot(summary_table, aes(x = FP_Rate, y = recall, color = Method)) + geom_point(size = 4) + geom_abline(slope = 1, intercept = 0, linetype = "dashed") + xlim(0, 1) + ylim(0, 1) + labs( title = "Trade-off: False Positives vs. False Negatives", subtitle = paste0("10,000 Simulations per Method \| AET = ", AET, " µg/mL"), x = "False Positive Rate (%)", y = "False Negative Rate (%)", color = "Correction Method" ) + theme_minimal()

ggplot(summary_table, aes(x = recall, y = precision, color = Method)) + geom_point(size = 4) + geom_abline(slope = 1, intercept = 0, linetype = "dashed") + \# Random guess line xlim(0, 1) + ylim(0, 1) + labs( title = "Trade-off: False Positives vs. False Negatives", subtitle = paste0("10,000 Simulations per Method \| AET = ", AET, " µg/mL"), x = "False Positive Rate (%)", y = "False Negative Rate (%)", color = "Correction Method" ) + theme_minimal()
