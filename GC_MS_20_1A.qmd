...
## A) Non-Parametric Bootstrap of the GC/MS dataset (20 µg/mL)
...
hist(base_conc_sim, 
     ...
     col = "skyblue")
hist(simulated_RRF,
     main = "Histogram of RRFs (non-parametric bootstrap of GC/MS dataset 10µg/mL) from FDA Clap list", 
     xlab = "Concentration",
     col = "grey")
```
...
## 1) Concentration around the AET
base_conc_sim <- sample(base_concentrations1, size = N_extractables, replace = TRUE)
## A) Non-Parametric Bootstrap of the GC/MS dataset (20µg/mL)
simulated_RRF <- sample(gcms_clap_clean$"20 µg/mL", size = N_extractables, replace = FALSE)
...
ggplot(plot_data, aes(x = Method, y = Rate*100, fill = Type)) +
  ...
  labs(
    title = "Comparison of GC-MS Correction Methods (20 µg/mL)",
