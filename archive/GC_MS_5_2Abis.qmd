...
RRF_superior0 <- gcms_clap_clean$"5 µg/mL"
...
## A) Sampling from the gamma distribution with parameter from the fit of the clap list
...
hist(base_conc_sim, 
     ...
     col = "skyblue")
hist(simulated_RRF,
     main = "Histogram of RRFs (gamma distribution fit of GC/MS dataset 5µg/mL) from FDA Clap list", 
     xlab = "Concentration",
     col = "grey")
```
