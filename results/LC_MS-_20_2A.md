...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-2-2.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-2-3.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-3-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-3-2.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-3-3.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-4-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-4-2.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-4-3.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-6-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-8-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-10-1.png)
...
simulated_RRF <- sample(lcmsneg_clap_clean$"20 µg/mL", size = N_extractables, replace = TRUE)
## I) No Correction
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-13-2.png)
...
set.seed(123)
N_sim <- 10000
UF_RSD <- 1/(1 - rsd(lcmsneg_clap_clean$"20 µg/mL")) # formula from ISO 10993-18
UF_list <- c(
  "UF (2)"   = 2, 
  "UF (4)"   = 4, 
  "UF (5)"   = 5, 
...
```
    ...
    1 No Correction 0.8587224 0.0004102392 0.001434337 2.352401e-05 0.9647944
    2        UF (2) 0.8154624 0.0080239558 0.001597469 1.036398e-04 0.6466603
    3        UF (4) 0.7811257 0.0235225792 0.001693622 1.761334e-04 0.4282713
    4        UF (5) 0.7829111 0.0307320754 0.001693778 2.005303e-04 0.3610004
    5       UF (10) 0.7824540 0.0563215799 0.001694150 2.678738e-04 0.2362182
    6      UF (RSD) 1.0000000 0.0000000000 0.000000000 0.000000e+00       NaN
         recall        F1    f_beta
    1 0.1412776 0.2464647 0.1460731
    2 0.1845376 0.2871354 0.1897531
    3 0.2188743 0.2896954 0.2230691
    4 0.2170889 0.2711318 0.2204693
    5 0.2175460 0.2264979 0.2182094
    6 0.0000000       NaN       NaN
...
RRF_LCMS_superior0 <- lcmsneg_clap_clean$"20 µg/mL"
...
```
    ...
    1          No Correction 0.8587224 0.0004102392 0.001434337 2.352401e-05
    2                 UF (2) 0.8154624 0.0080239558 0.001597469 1.036398e-04
    3                 UF (4) 0.7811257 0.0235225792 0.001693622 1.761334e-04
    4                 UF (5) 0.7829111 0.0307320754 0.001693778 2.005303e-04
    5                UF (10) 0.7824540 0.0563215799 0.001694150 2.678738e-04
    6               UF (RSD) 1.0000000 0.0000000000 0.000000000 0.000000e+00
    7 Mean/Percentile (16th) 0.6892265 0.1808588305 0.001905860 4.471272e-04
    8                 RRFlow 0.0712710 0.0374738928 0.001675725 3.522907e-04
    9                  RRF<1 0.0795011 0.0309088219 0.001761976 3.210362e-04
      precision    recall        F1    f_beta
    1 0.9647944 0.1412776 0.2464647 0.1460731
    2 0.6466603 0.1845376 0.2871354 0.1897531
    3 0.4282713 0.2188743 0.2896954 0.2230691
    4 0.3610004 0.2170889 0.2711318 0.2204693
    5 0.2362182 0.2175460 0.2264979 0.2182094
    6       NaN 0.0000000       NaN       NaN
    7 0.1202904 0.3107735 0.1734456 0.2929324
    8 0.6677851 0.9287290 0.7769319 0.9149776
    9 0.7072129 0.9204989 0.7998820 0.9099440
...
conservative_RRF_estimate <- quantile(lcmsneg_clap_clean$"20 µg/mL", 0.10)
...
conservative_RRF_estimate <- quantile(lcmsneg_clap_clean$"20 µg/mL", 0.20)
...
```
    ...
    11        Percentile 20th 0.0000000 1.0000000000 0.000000000 0.000000e+00
        precision    recall        F1    f_beta
    1  0.96479444 0.1412776 0.2464647 0.1460731
    2  0.64666033 0.1845376 0.2871354 0.1897531
    3  0.42827129 0.2188743 0.2896954 0.2230691
    4  0.36100039 0.2170889 0.2711318 0.2204693
    5  0.23621817 0.2175460 0.2264979 0.2182094
    6         NaN 0.0000000       NaN       NaN
    7  0.12029039 0.3107735 0.1734456 0.2929324
    8  0.66778513 0.9287290 0.7769319 0.9149776
    9  0.70721293 0.9204989 0.7998820 0.9099440
...
ggplot(plot_data, aes(x = Method, y = Rate*100, fill = Type)) +
  ...
  labs(
    title = paste0("Comparison of LC-MS neg Correction Methods (20 µg/mL)", " AET=", AET, "µg/mL"),
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-24-1.png)
...
```
    ...
    1           No Correction      0.96   0.14 0.25   0.15
    2                  UF (2)      0.65   0.18 0.29   0.19
    3                  UF (4)      0.43   0.22 0.29   0.22
    4                  UF (5)      0.36   0.22 0.27   0.22
    5                 UF (10)      0.24   0.22 0.23   0.22
    6                UF (RSD)       NaN   0.00  NaN    NaN
    7  Mean/Percentile (16th)      0.12   0.31 0.17   0.29
    8                  RRFlow      0.67   0.93 0.78   0.91
    9                   RRF<1      0.71   0.92 0.80   0.91
...
ggplot(all_distributions, aes(x = Method, y = F5)) +
  ...
  labs(
    title = paste0("Distribution of F5 scores | Comparison of LC-MS neg Correction Methods (20 µg/mL)", " AET=", AET, "µg/mL"),
    subtitle = "Conc. from Log/Normal Distribution, RRF sampled from CLAP list data") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-26-1.png)
...
```
    ...
    # A tibble: 11 × 5
       ...
       <fct>                    <dbl>  <dbl>   <dbl> <dbl>
     1 No Correction            0.217 0.220    0.145 0.162
     2 UF (2)                   0.258 0.221    0.188 0.178
     3 UF (4)                   0.265 0.204    0.221 0.187
     4 UF (5)                   0.249 0.193    0.218 0.187
     5 UF (10)                  0.210 0.166    0.214 0.181
     6 UF (RSD)                 0     0        0     0    
     7 Mean/Percentile (16th)   0.167 0.111    0.286 0.188
     8 RRFlow                   0.710 0.295    0.831 0.310
     9 RRF<1                    0.728 0.300    0.826 0.314
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-28-1.png)
...
![](LC_MS-_20_2A_files/figure-commonmark/unnamed-chunk-28-2.png)
