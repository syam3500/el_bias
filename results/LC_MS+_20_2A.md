...
simulated_RRF <- sample(lcmspos_clap_clean$"20 µg/mL", size = N_extractables, replace = TRUE)
## I) No Correction
...
set.seed(123)
N_sim <- 10000
UF_RSD <- 1/(1 - rsd(lcmspos_clap_clean$"20 µg/mL")) # formula from ISO 10993-18
UF_list <- c(
  "UF (2)"   = 2, 
  "UF (4)"   = 4, 
  "UF (5)"   = 5, 
...
```
    ...
    1 No Correction 0.5350458 0.01584515 0.003785194 0.0001411561 0.39430497
    2        UF (2) 0.3907159 0.03512740 0.003702781 0.0002081027 0.27787555
    3        UF (4) 0.3378964 0.07026613 0.003572227 0.0002889476 0.17432309
    4        UF (5) 0.3266946 0.08449493 0.003579040 0.0003143493 0.14878968
    5       UF (10) 0.3099774 0.14237969 0.003519355 0.0003949711 0.09659455
    6      UF (RSD) 1.0000000 0.00000000 0.000000000 0.0000000000        NaN
         recall        F1    f_beta
    1 0.4649542 0.4267252 0.4617720
    2 0.6092841 0.3816791 0.5825613
    3 0.6621036 0.2759834 0.5977710
    4 0.6733054 0.2437209 0.5929149
    5 0.6900226 0.1694660 0.5581405
    6 0.0000000       NaN       NaN
...
RRF_LCMS_superior0 <- lcmspos_clap_clean$"20 µg/mL"
...
```
    ...
    1          No Correction 0.53504579 0.01584515 0.003785194 0.0001411561
    2                 UF (2) 0.39071589 0.03512740 0.003702781 0.0002081027
    3                 UF (4) 0.33789642 0.07026613 0.003572227 0.0002889476
    4                 UF (5) 0.32669462 0.08449493 0.003579040 0.0003143493
    5                UF (10) 0.30997742 0.14237969 0.003519355 0.0003949711
    6               UF (RSD) 1.00000000 0.00000000 0.000000000 0.0000000000
    7 Mean/Percentile (16th) 0.28059667 0.20370619 0.003409692 0.0004552591
    8                 RRFlow 0.05909484 0.01529257 0.002001776 0.0001544234
    9                  RRF<1 0.07523782 0.04383966 0.002239242 0.0002576429
       precision    recall        F1    f_beta
    1 0.39430497 0.4649542 0.4267252 0.4617720
    2 0.27787555 0.6092841 0.3816791 0.5825613
    3 0.17432309 0.6621036 0.2759834 0.5977710
    4 0.14878968 0.6733054 0.2437209 0.5929149
    5 0.09659455 0.6900226 0.1694660 0.5581405
    6        NaN 0.0000000       NaN       NaN
    7 0.07265631 0.7194033 0.1319830 0.5359228
    8 0.57482499 0.9409052 0.7136571 0.9184093
    9 0.31671438 0.9247622 0.4718341 0.8611725
...
conservative_RRF_estimate <- quantile(lcmspos_clap_clean$"20 µg/mL", 0.10)
...
conservative_RRF_estimate <- quantile(lcmspos_clap_clean$"20 µg/mL", 0.20)
...
```
    ...
    8                  RRFlow 0.05909484 0.01529257 0.002001776 0.0001544234
    9                   RRF<1 0.07523782 0.04383966 0.002239242 0.0002576429
    10        Percentile 10th 0.00000000 1.00000000 0.000000000 0.0000000000
    11        Percentile 20th 0.20221160 0.62929941 0.003048137 0.0005459591
        precision    recall         F1    f_beta
    1  0.39430497 0.4649542 0.42672516 0.4617720
    2  0.27787555 0.6092841 0.38167911 0.5825613
    3  0.17432309 0.6621036 0.27598340 0.5977710
    4  0.14878968 0.6733054 0.24372095 0.5929149
    5  0.09659455 0.6900226 0.16946597 0.5581405
    6         NaN 0.0000000        NaN       NaN
    7  0.07265631 0.7194033 0.13198297 0.5359228
    8  0.57482499 0.9409052 0.71365711 0.9184093
    9  0.31671438 0.9247622 0.47183409 0.8611725
    10 0.02163552 1.0000000 0.04235467 0.3650645
    11 0.02735576 0.7977884 0.05289769 0.3829612
...
ggplot(plot_data, aes(x = Method, y = Rate*100, fill = Type)) +
  ...
  labs(
    title = paste0("Comparison of LC-MS+ Correction Methods (20 µg/mL)", " AET=", AET, "µg/mL"),
...
![](LC_MS+_20_2A_files/figure-commonmark/unnamed-chunk-23-1.png)
...
```
    ...
    1           No Correction      0.39   0.46 0.43   0.46
    2                  UF (2)      0.28   0.61 0.38   0.58
    3                  UF (4)      0.17   0.66 0.28   0.60
    4                  UF (5)      0.15   0.67 0.24   0.59
    5                 UF (10)      0.10   0.69 0.17   0.56
    6                UF (RSD)       NaN   0.00  NaN    NaN
    7  Mean/Percentile (16th)      0.07   0.72 0.13   0.54
    8                  RRFlow      0.57   0.94 0.71   0.92
    9                   RRF<1      0.32   0.92 0.47   0.86
    10        Percentile 10th      0.02   1.00 0.04   0.37
    11        Percentile 20th      0.03   0.80 0.05   0.38
...
ggplot(all_distributions, aes(x = Method, y = F5)) +
  ...
  labs(
    title = paste0("Distribution of F5 scores | LC-MS+ Correction Methods (20 µg/mL)", " AET=", AET, "µg/mL"),
    subtitle = "Conc. from Log/Normal Distribution, RRF sampled from CLAP list data") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

![](LC_MS+_20_2A_files/figure-commonmark/unnamed-chunk-25-1.png)
...
```
    ...
    # A tibble: 11 × 5
       ...
       <fct>                    <dbl>  <dbl>   <dbl> <dbl>
     1 No Correction           0.332  0.335    0.374 0.386
     2 UF (2)                  0.326  0.280    0.472 0.392
     3 UF (4)                  0.250  0.205    0.493 0.370
     4 UF (5)                  0.223  0.185    0.485 0.363
     5 UF (10)                 0.159  0.135    0.455 0.334
     6 UF (RSD)                0      0        0     0    
     7 Mean/Percentile (16th)  0.126  0.107    0.439 0.313
     8 RRFlow                  0.573  0.387    0.688 0.432
     9 RRF<1                   0.408  0.301    0.648 0.415
    10 Percentile 10th         0.0417 0.0349   0.306 0.207
    11 Percentile 20th         0.0519 0.0434   0.324 0.222
...
![](LC_MS+_20_2A_files/figure-commonmark/unnamed-chunk-27-1.png)
...
![](LC_MS+_20_2A_files/figure-commonmark/unnamed-chunk-27-2.png)
