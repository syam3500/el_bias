...
simulated_RRF <- sample(lcmspos_clap_clean$"5 µg/mL", size = N_extractables, replace = TRUE)
## I) No Correction
...
set.seed(123)
N_sim <- 10000
UF_RSD <- 1/(1 - rsd(lcmspos_clap_clean$"5 µg/mL")) # formula from ISO 10993-18
UF_list <- c(
  "UF (2)"   = 2, 
  "UF (4)"   = 4, 
  "UF (5)"   = 5, 
...
```
    ...
    1 No Correction 0.5465014 0.02790668 0.002047153 0.0001913548 0.5646819
    2        UF (2) 0.4288782 0.06127187 0.002035158 0.0002786325 0.4266190
    3        UF (4) 0.3638687 0.11565961 0.001966524 0.0003717422 0.3078509
    4        UF (5) 0.3521576 0.13857392 0.001966391 0.0004013666 0.2712711
    5       UF (10) 0.3160470 0.21651384 0.001909631 0.0004785533 0.2017828
    6      UF (RSD) 1.0000000 0.00000000 0.000000000 0.0000000000       NaN
         recall        F1    f_beta
    1 0.4534986 0.5030197 0.4569591
    2 0.5711218 0.4884062 0.5637771
    3 0.6361313 0.4149095 0.6110689
    4 0.6478424 0.3824140 0.6150065
    5 0.6839530 0.3116278 0.6263847
    6 0.0000000       NaN       NaN
...
RRF_LCMS_superior0 <- lcmspos_clap_clean$"5 µg/mL"
...
```
    ...
    1          No Correction 0.54650140 0.02790668 0.0020471530 0.0001913548
    2                 UF (2) 0.42887822 0.06127187 0.0020351576 0.0002786325
    3                 UF (4) 0.36386875 0.11565961 0.0019665236 0.0003717422
    4                 UF (5) 0.35215755 0.13857392 0.0019663908 0.0004013666
    5                UF (10) 0.31604697 0.21651384 0.0019096312 0.0004785533
    6               UF (RSD) 1.00000000 0.00000000 0.0000000000 0.0000000000
    7 Mean/Percentile (16th) 0.27877169 0.35724332 0.0018438577 0.0005567198
    8                 RRFlow 0.05037804 0.04274111 0.0009996041 0.0002616830
    9                  RRF<1 0.06357826 0.08007953 0.0011151212 0.0003511348
      precision    recall        F1    f_beta
    1 0.5646819 0.4534986 0.5030197 0.4569591
    2 0.4266190 0.5711218 0.4884062 0.5637771
    3 0.3078509 0.6361313 0.4149095 0.6110689
    4 0.2712711 0.6478424 0.3824140 0.6150065
    5 0.2017828 0.6839530 0.3116278 0.6263847
    6       NaN 0.0000000       NaN       NaN
    7 0.1387869 0.7212283 0.2327797 0.6209937
    8 0.6403391 0.9496220 0.7648994 0.9323027
    9 0.4837505 0.9364217 0.6379431 0.9038903
...
conservative_RRF_estimate <- quantile(RRF_LCMS_superior0, 0.10)
...
conservative_RRF_estimate <- quantile(RRF_LCMS_superior0, 0.20)
...
```
    ...
    8                  RRFlow 0.05037804 0.04274111 0.0009996041 0.0002616830
    9                   RRF<1 0.06357826 0.08007953 0.0011151212 0.0003511348
    10        Percentile 10th 0.26810173 0.42479571 0.0018215532 0.0005742916
    11        Percentile 20th 0.32082586 0.21755199 0.0019195169 0.0004793366
       precision    recall        F1    f_beta
    1  0.5646819 0.4534986 0.5030197 0.4569591
    2  0.4266190 0.5711218 0.4884062 0.5637771
    3  0.3078509 0.6361313 0.4149095 0.6110689
    ...
    8  0.6403391 0.9496220 0.7648994 0.9323027
    9  0.4837505 0.9364217 0.6379431 0.9038903
    10 0.1209029 0.7318983 0.2075246 0.6127906
    11 0.1994874 0.6791741 0.3083934 0.6216785
...
![](LC_MS+_5_2A_files/figure-commonmark/unnamed-chunk-23-1.png)
...
```
    ...
    1           No Correction      0.56   0.45 0.50   0.46
    2                  UF (2)      0.43   0.57 0.49   0.56
    3                  UF (4)      0.31   0.64 0.41   0.61
    4                  UF (5)      0.27   0.65 0.38   0.62
    5                 UF (10)      0.20   0.68 0.31   0.63
    6                UF (RSD)       NaN   0.00  NaN    NaN
    7  Mean/Percentile (16th)      0.14   0.72 0.23   0.62
    8                  RRFlow      0.64   0.95 0.76   0.93
    9                   RRF<1      0.48   0.94 0.64   0.90
    10        Percentile 10th      0.12   0.73 0.21   0.61
    11        Percentile 20th      0.20   0.68 0.31   0.62
...
![](LC_MS+_5_2A_files/figure-commonmark/unnamed-chunk-25-1.png)
...
```
    ...
    # A tibble: 11 × 5
       ...
       <fct>                    <dbl>  <dbl>   <dbl> <dbl>
     1 No Correction            0.475 0.211    0.453 0.228
     2 UF (2)                   0.468 0.178    0.557 0.218
     3 UF (4)                   0.401 0.150    0.602 0.203
     4 UF (5)                   0.370 0.141    0.605 0.199
     5 UF (10)                  0.304 0.119    0.613 0.188
     6 UF (RSD)                 0     0        0     0    
     7 Mean/Percentile (16th)   0.228 0.0927   0.604 0.173
     8 RRFlow                   0.746 0.165    0.921 0.131
     9 RRF<1                    0.620 0.166    0.890 0.139
    10 Percentile 10th          0.204 0.0838   0.594 0.168
    11 Percentile 20th          0.300 0.119    0.609 0.188
...
![](LC_MS+_5_2A_files/figure-commonmark/unnamed-chunk-27-1.png)
...
![](LC_MS+_5_2A_files/figure-commonmark/unnamed-chunk-27-2.png)
