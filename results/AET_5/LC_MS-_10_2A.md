...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-2-2.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-2-3.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-3-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-3-2.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-3-3.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-4-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-4-2.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-4-3.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-6-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-8-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-10-1.png)
...
simulated_RRF <- sample(lcmsneg_clap_clean$"10 µg/mL", size = N_extractables, replace = TRUE)
## I) No Correction
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-13-2.png)
...
set.seed(123)
N_sim <- 10000
UF_RSD <- 1/(1 - rsd(lcmsneg_clap_clean$"10 µg/mL")) # formula from ISO 10993-18
UF_list <- c(
  "UF (2)"   = 2, 
  "UF (4)"   = 4, 
  "UF (5)"   = 5, 
...
```
    ...
    1 No Correction 0.8628432 0.0002442543 0.001416651 1.815306e-05 0.9781110
    2        UF (2) 0.8215673 0.0075152052 0.001576692 1.003262e-04 0.6539059
    3        UF (4) 0.7813438 0.0220557945 0.001693014 1.706816e-04 0.4438579
    4        UF (5) 0.7830123 0.0290540623 0.001693493 1.951475e-04 0.3739419
    5       UF (10) 0.7827912 0.0541843922 0.001693202 2.630397e-04 0.2429833
    6      UF (RSD) 1.0000000 0.0000000000 0.000000000 0.000000e+00       NaN
         recall        F1    f_beta
    1 0.1371568 0.2405782 0.1418475
    2 0.1784327 0.2803624 0.1835664
    3 0.2186562 0.2929817 0.2230080
    4 0.2169877 0.2746208 0.2205481
    5 0.2172088 0.2293742 0.2180986
    6 0.0000000       NaN       NaN
...
RRF_LCMS_superior0 <- lcmsneg_clap_clean$"10 µg/mL"
...
```
    ...
    1          No Correction 0.8628432 0.0002442543 0.001416651 1.815306e-05
    2                 UF (2) 0.8215673 0.0075152052 0.001576692 1.003262e-04
    3                 UF (4) 0.7813438 0.0220557945 0.001693014 1.706816e-04
    4                 UF (5) 0.7830123 0.0290540623 0.001693493 1.951475e-04
    5                UF (10) 0.7827912 0.0541843922 0.001693202 2.630397e-04
    6               UF (RSD) 1.0000000 0.0000000000 0.000000000 0.000000e+00
    7 Mean/Percentile (16th) 0.6905323 0.1764784469 0.001903653 4.428587e-04
    8                 RRFlow 0.0712710 0.0382274308 0.001675725 3.556758e-04
    9                  RRF<1 0.0795011 0.0315316090 0.001761976 3.241502e-04
      precision    recall        F1    f_beta
    1 0.9781110 0.1371568 0.2405782 0.1418475
    2 0.6539059 0.1784327 0.2803624 0.1835664
    3 0.4438579 0.2186562 0.2929817 0.2230080
    4 0.3739419 0.2169877 0.2746208 0.2205481
    5 0.2429833 0.2172088 0.2293742 0.2180986
    6       NaN 0.0000000       NaN       NaN
    7 0.1224560 0.3094677 0.1754762 0.2922988
    8 0.6633537 0.9287290 0.7739244 0.9146556
    9 0.7030653 0.9204989 0.7972223 0.9096784
...
conservative_RRF_estimate <- quantile(lcmsneg_clap_clean$"10 µg/mL", 0.10)
...
conservative_RRF_estimate <- quantile(lcmsneg_clap_clean$"10 µg/mL", 0.20)
...
```
    ...
    8                  RRFlow 0.0712710 0.0382274308 0.001675725 3.556758e-04
    9                   RRF<1 0.0795011 0.0315316090 0.001761976 3.241502e-04
    10        Percentile 10th 0.0000000 1.0000000000 0.000000000 0.000000e+00
    11        Percentile 20th 0.0000000 1.0000000000 0.000000000 0.000000e+00
        precision    recall        F1    f_beta
    1  0.97811102 0.1371568 0.2405782 0.1418475
    2  0.65390591 0.1784327 0.2803624 0.1835664
    3  0.44385792 0.2186562 0.2929817 0.2230080
    4  0.37394188 0.2169877 0.2746208 0.2205481
    5  0.24298325 0.2172088 0.2293742 0.2180986
    6         NaN 0.0000000       NaN       NaN
    7  0.12245596 0.3094677 0.1754762 0.2922988
    8  0.66335374 0.9287290 0.7739244 0.9146556
    9  0.70306526 0.9204989 0.7972223 0.9096784
    10 0.07356139 1.0000000 0.1370418 0.6736783
    11 0.07356139 1.0000000 0.1370418 0.6736783
...
ggplot(plot_data, aes(x = Method, y = Rate*100, fill = Type)) +
  ...
  labs(
    title = paste0("Comparison of LC-MS neg Correction Methods (10 µg/mL)", " AET=", AET, "µg/mL"),
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-24-1.png)
...
```
    ...
    1           No Correction      0.98   0.14 0.24   0.14
    2                  UF (2)      0.65   0.18 0.28   0.18
    3                  UF (4)      0.44   0.22 0.29   0.22
    4                  UF (5)      0.37   0.22 0.27   0.22
    5                 UF (10)      0.24   0.22 0.23   0.22
    6                UF (RSD)       NaN   0.00  NaN    NaN
    7  Mean/Percentile (16th)      0.12   0.31 0.18   0.29
    8                  RRFlow      0.66   0.93 0.77   0.91
    9                   RRF<1      0.70   0.92 0.80   0.91
    10        Percentile 10th      0.07   1.00 0.14   0.67
    11        Percentile 20th      0.07   1.00 0.14   0.67
...
ggplot(all_distributions, aes(x = Method, y = F5)) +
  ...
  labs(
    title = paste0("Distribution of F5 scores | Comparison of LC-MS neg Correction Methods (10 µg/mL)", " AET=", AET, "µg/mL"),
    subtitle = "Conc. from Log/Normal Distribution, RRF sampled from CLAP list data") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-26-1.png)
...
```
    ...
    # A tibble: 11 × 5
       ...
       <fct>                    <dbl>  <dbl>   <dbl> <dbl>
     1 No Correction            0.211 0.218    0.141 0.160
     2 UF (2)                   0.251 0.220    0.182 0.176
     3 UF (4)                   0.267 0.206    0.221 0.187
     4 UF (5)                   0.251 0.196    0.218 0.187
     5 UF (10)                  0.213 0.168    0.214 0.181
     6 UF (RSD)                 0     0        0     0    
     7 Mean/Percentile (16th)   0.168 0.112    0.286 0.188
     8 RRFlow                   0.708 0.295    0.830 0.309
     9 RRF<1                    0.726 0.299    0.826 0.313
    10 Percentile 10th          0.133 0.0803   0.593 0.226
    11 Percentile 20th          0.133 0.0803   0.593 0.226
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-28-1.png)
...
![](LC_MS-_10_2A_files/figure-commonmark/unnamed-chunk-28-2.png)
